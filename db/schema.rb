...
ActiveRecord::Schema.define(version: 20_181_129_103_819) do
  ...
  create_table 'authentication_providers', id: :integer, force: :cascade,
                                           options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3' do |t|
    t.string 'name'
  ...
  create_table 'brands_categories', id: :integer, force: :cascade,
                                    options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3' do |t|
    t.integer 'brand_id'
    t.integer 'category_id'
    t.index %w[brand_id category_id], name: 'by_brand_category', unique: true
  ...
  create_table 'categories_icons', id: :integer, force: :cascade,
                                   options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3' do |t|
    t.integer 'category_id'
    t.integer 'icon_id'
  ...
  create_table 'categorizations', id: :integer, force: :cascade, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3' do |t|
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w[category_id product_id], name: 'index_categorizations_on_category_id_and_product_id'
  ...
  create_table 'colorizations_words', id: :integer, force: :cascade,
                                      options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3' do |t|
    t.integer 'colorization_id'
    t.integer 'word_id'
  ...
  create_table 'entries', id: :integer, force: :cascade, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3' do |t|
    ...
    t.binary 'summary', limit: 16_777_215
    t.binary 'content', limit: 16_777_215
    t.integer 'scope_id'
    t.integer 'user_id'
    t.integer 'feed_id'
    t.datetime 'created_at', null: false
  ...
  create_table 'fashion_fly_editor_categories', id: :integer, force: :cascade,
                                                options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3' do |t|
    t.string 'name'
    t.string 'slug'
    t.integer 'parent_id'
    ...
    t.datetime 'updated_at'
    t.integer 'scope_id'
    t.index %w[parent_id parent_type], name: 'category_parent'
  ...
  create_table 'fashion_fly_editor_collection_items', id: :integer, force: :cascade,
                                                      options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3' do |t|
  ...
  create_table 'fashion_fly_editor_collections', id: :integer, force: :cascade,
                                                 options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3' do |t|
    t.string 'title'
    t.text 'description'
    t.string 'image'
  ...
  create_table 'fashion_fly_editor_subscriptions', id: :integer, force: :cascade,
                                                   options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3' do |t|
    t.integer 'collection_id'
    ...
    t.index %w[subscriber_id subscriber_type], name: 'subscriber'
  end
  ...
  create_table 'favorites', id: :integer, force: :cascade, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3' do |t|
    ...
    t.index %w[markable_id markable_type], name: 'index_favorites_on_markable_id_and_markable_type'
  ...
  create_table 'feeds', id: :integer, force: :cascade, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3' do |t|
    t.integer 'user_id'
    t.binary 'value', limit: 16_777_215
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
  ...
  create_table 'lit_incomming_localizations', id: :integer, force: :cascade,
                                              options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3' do |t|
  ...
  create_table 'lit_localization_keys', id: :integer, force: :cascade,
                                        options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3' do |t|
  ...
  create_table 'lit_localization_versions', id: :integer, force: :cascade,
                                            options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3' do |t|
    t.text 'translated_value'
    t.integer 'localization_id'
    t.datetime 'created_at'
  ...
  create_table 'lit_localizations', id: :integer, force: :cascade,
                                    options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3' do |t|
    t.integer 'locale_id'
    t.integer 'localization_key_id'
    ...
    t.index %w[localization_key_id locale_id], name: 'index_lit_localizations_on_localization_key_id_and_locale_id',
                                               unique: true
  ...
  create_table 'overall_averages', id: :integer, force: :cascade,
                                   options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3' do |t|
    t.string 'rateable_type'
    t.integer 'rateable_id'
  ...
  create_table 'pages', id: :integer, force: :cascade, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3' do |t|
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w[name scope_id], name: 'index_pages_on_name_and_scope_id', unique: true
  ...
  create_table 'products', id: :integer, force: :cascade, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3' do |t|
    ...
    t.index %w[affiliate_id affi_code scope_id],
            name: 'index_products_on_affiliate_id_and_affi_code_and_scope_id', unique: true
  ...
  create_table 'simple_hashtag_hashtaggings', id: :integer, force: :cascade,
                                              options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3' do |t|
    t.integer 'hashtag_id'
    t.string 'hashtaggable_type'
    t.integer 'hashtaggable_id'
    t.index ['hashtag_id'], name: 'index_simple_hashtag_hashtaggings_on_hashtag_id'
    t.index %w[hashtaggable_id hashtaggable_type], name: 'index_hashtaggings_hashtaggable_id_hashtaggable_type'
  end

  create_table 'simple_hashtag_hashtags', id: :integer, force: :cascade,
                                          options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3' do |t|
    t.string 'name'
    t.string 'scope_id'
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w[name scope_id], name: 'index_simple_hashtag_hashtags_on_name_and_scope_id', unique: true
  ...
  create_table 'user_authentications', id: :integer, force: :cascade,
                                       options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3' do |t|
    t.integer 'user_id'
  ...
  create_table 'visits', id: :integer, force: :cascade, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3' do |t|
    ...
    t.index %w[user_id cookie visitable_id visitable_type], name: 'visitings', unique: true
    t.index ['user_id'], name: 'index_visits_on_user_id'
    t.index %w[visitable_id visitable_type], name: 'index_visits_on_visitable_id_and_visitable_type'
  end
