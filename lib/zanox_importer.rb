...
class ZanoxImporter
  def xml_list
    [
      ...
      { advertiser: 'Karen_Miller',
        file_url: 'http://productdata.zanox.com/exportservice/v1/rest/28724417C45114353.xml?ticket=D2806ABA3D821F26C1C378EF1B6DBA79&gZipCompress=null' },
      { advertiser: 'phillip_plein',
        file_url: 'http://productdata.zanox.com/exportservice/v1/rest/28724455C44315366.xml?ticket=D2806ABA3D821F26C1C378EF1B6DBA79&gZipCompress=null' },
      { advertiser: 'Dawanda',
        file_url: 'http://productdata.zanox.com/exportservice/v1/rest/28724462C34773720.xml?ticket=D2806ABA3D821F26C1C378EF1B6DBA79&gZipCompress=null' },
      { advertiser: 'mirapodo',
        file_url: 'http://productdata.zanox.com/exportservice/v1/rest/28723785C81010184.xml?ticket=D2806ABA3D821F26C1C378EF1B6DBA79&gZipCompress=null' },
      { advertiser: 'wardow',
        file_url: 'http://productdata.zanox.com/exportservice/v1/rest/28724471C28815849.xml?ticket=D2806ABA3D821F26C1C378EF1B6DBA79&gZipCompress=null' },
      { advertiser: 'joop',
        file_url: 'http://productdata.zanox.com/exportservice/v1/rest/28724473C39642302.xml?ticket=D2806ABA3D821F26C1C378EF1B6DBA79&gZipCompress=null' },
      { advertiser: 'esprit',
        file_url: 'http://productdata.zanox.com/exportservice/v1/rest/28724477C79684775.xml?ticket=D2806ABA3D821F26C1C378EF1B6DBA79&gZipCompress=null' },
      { advertiser: 'superdry',
        file_url: 'http://productdata.zanox.com/exportservice/v1/rest/28724478C79510495.xml?ticket=D2806ABA3D821F26C1C378EF1B6DBA79&gZipCompress=null' },
      { advertiser: 'impressions',
        file_url: 'http://productdata.zanox.com/exportservice/v1/rest/28724482C50023966.xml?ticket=D2806ABA3D821F26C1C378EF1B6DBA79&gZipCompress=null' },
      { advertiser: 'promod',
        file_url: 'http://productdata.zanox.com/exportservice/v1/rest/28724483C85467518.xml?ticket=D2806ABA3D821F26C1C378EF1B6DBA79&gZipCompress=null' },
      { advertiser: 'breuniger',
        file_url: 'http://productdata.zanox.com/exportservice/v1/rest/27961728C57589461.xml?ticket=D2806ABA3D821F26C1C378EF1B6DBA79&gZipCompress=null' },
      { advertiser: 'jades',
        file_url: 'http://productdata.zanox.com/exportservice/v1/rest/27965103C8770737.xml?ticket=D2806ABA3D821F26C1C378EF1B6DBA79&gZipCompress=null' },
  ...
  def sync_product(zone, attributes, values)
    ...
    if categories.present?
      ...
      categorie_names = categorie_names[0] if categorie_names..is_a?(Array) && categorie_names.length.zero?
      ...
      categorie_names.each(&:strip!)
    end
    category_id = nil
    catorie_ids = []
    categorie_names.each do |category_name|
  ...
  def colorname(mycolor)
    _colors = %w[e7db9c ffff02 7cfe6f ffdfef
